...
#define MIN_SCORE 0
/**
 * @brief This fuction calculates from a given grades file it's minimum
 ...
 * @note the function also prints the minimum out of the grades 
*/
int calc_min(FILE *fp);
